...
That is, for most problems with the F-16 E&E systems the hardest part is finding the problem. [A](#A)
...
- decreased [systems programming](https://en.wikipedia.org/wiki/Systems_programming) ability

That is, for a significant portion of the non-trivial problems with multi-tier architecture software systems the hardest part is getting the elevated access to do (single mind) ad hoc telemetry based troubleshooting. [C](#C)
...
They are often advertised as a "single pane of glass." [D](#D)

They've got metrics over time which can be shown on a graph (which sometimes includes a bright dashed "red line"). [E](#E)
...
In the software world, I've never come across such a troubleshooting decision tree. [F](#F)
...
In software IT/Infrastructure, gatekeepers mostly keep the gate closed. [G](#G)
...
I have never come across a deployed monitoring service that allows me to get that kind of granular ad hoc telemetry derived information. [H](#H)
Also I don't often come across software engineers that know how to inspect the whole software stack with tools and techniques like that. [B](#B)
...
Maybe the engineers spend an exorbitant amount of time replicating the problem in an environment where they do have elevated access to run the commands they need to run. [I](#I)
